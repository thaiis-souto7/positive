...
const funcionario_schema_1 = require("./interfaces/funcionario.schema");
let FuncionariosModule = class FuncionariosModule {
};
FuncionariosModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Funcionario', schema: funcionario_schema_1.FuncionarioSchema }])],
